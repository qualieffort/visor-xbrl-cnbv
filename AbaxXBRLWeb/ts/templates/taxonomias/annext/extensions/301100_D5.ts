...
export var http___www_cnbv_gob_mx_2016_08_22_annext_roles_301100_D5_annext_NumberOfAssetsGroupedInArrearsAtTheEndOfThePeriodTable = {
  "FiltroCargaInicial": {
    "IdConcepto": [
  ...
  "TemplatesDimensiones": {
    "annext_TimeIntervalAxis": {
      ...
      "SubfijoValor": "",
      "EtiquetaNuevoElemento": "LessThan1MonthOrLessThan30DaysMember",
      "Explicita": true,
