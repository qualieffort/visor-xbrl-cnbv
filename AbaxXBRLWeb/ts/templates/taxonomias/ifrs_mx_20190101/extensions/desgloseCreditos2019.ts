...
module abaxXBRL.templates.extensions {
    ...
    var desgloseCreditosModule2019: ng.IModule = angular.module('abaxXbrlDesgloseCreditosViewerCNBV2019', ['abaxVisorXBRLViewer', 'pascalprecht.translate', 'tmh.dynamicLocale']);
